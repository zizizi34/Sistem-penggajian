...
@section('content')
	...
	<!-- Modal markup retained (same as before) -->
	<div id="modalAdd" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
		<div class="bg-white rounded-lg p-6 w-full max-w-2xl">
			...
			<div id="modalJadwal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
